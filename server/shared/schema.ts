...
export const graduationYearEnum = pgEnum("graduation_year", ["2020", "2021", "2022", "2023", "2024", "2025", "2026", "2027", "2028", "2029", "2030"]);
...
export const users = pgTable("users", {
  ...
  age: integer("age"),
  gender: varchar("gender"), // Use varchar instead of enum to avoid issues
  profileImageUrl: varchar("profile_image_url"),
  phone: varchar("phone"),
  password: varchar("password"), // Hashed password for simple auth
  college: varchar("college"), // Use varchar instead of enum
  branch: varchar("branch"), // Keep as varchar
  graduationYear: varchar("graduation_year"), // Use varchar instead of enum
